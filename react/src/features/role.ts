...
export const roles: Role[] = [
  {
    ...
    description: '平和な村に住む無垢でかわいい村人さん。特殊な能力はありません。他プレイヤーの言葉だけをヒントに、誰が人狼か推理しましょう。'
  },
  {
    roleId: 2,
    roleType: 'jinroh',
    ...
    description: 'イタズラ好きなかわいい人狼さん。 夜の間に他の人狼プレイヤーを確認することができます。'
  },
  {
    roleId: 3,
    roleType: 'murabito',
    ...
    description: 'ミステリアスでクールな雰囲気の占い師さん。 夜の間に、他プレイヤーまたは場のカードを選択します。他プレイヤーのカードを選択した場合、そのプレイヤーの役職を確認できます。 場のカードを選択した場合、場にあるカード2枚の役職を確認できます。この行動は怪盗が役職を取り替える前に行われます。'
  },
  {
    roleId: 4,
    roleType: 'murabito',
    ...
    description: '狙った獲物のハートを盗む怪盗さん。夜の間に、他プレイヤーのカードを選択すると「自分の役職」と「選択したプレイヤーの役職」を 入れ替えることができます。（入れ替えなくても良い）カードの交換は各自の役職確認後に行われるため、交換されたプレイヤーは 交換されたことを知らないままゲームがスタートします。勝利条件は交換後の役職に準じます。'
  },
  {
    roleId: 5,
    roleType: 'jinroh',
    ...
    nightAction: '夜の行動はありません。',
    description: '人狼さんにひそかな思いを寄せる狂人さん。 特殊な能力はありませんが、村人とは陣営が異なり、人狼陣営に所属します。 狂人が吊られても人狼陣営の敗北にはなりません。 プレイヤーに人狼がいない平和村の場合、勝利条件は「人間 SIDE」となります(村人と同じ扱いとなります)。'
  },
  {
    roleId: 6,
    roleType: 'turibito',
    ...
    nightAction: '夜の行動はありません。',
    description: '丈夫な縄を自分の首にかけてぶら下がる不思議な遊びが大好きな吊人さん。 吊られるのが目的です。吊られると一人勝ちとなります。'
  },
];
