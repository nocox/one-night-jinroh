...
export default {
    ...
    mounted() {
        axios.get('http://ec2-52-198-98-214.ap-northeast-1.compute.amazonaws.com:8080/talk-index',{withCredentials: true})
        .then((response) => {
    ...
    methods: {
        ...
        endTalk() {
            axios.get('http://ec2-52-198-98-214.ap-northeast-1.compute.amazonaws.com:8080/end-talk',{withCredentials: true})
            .then((response) => {
                console.log(response.data);
            }).catch(() => {
                this.$router.push('/temp-room');
