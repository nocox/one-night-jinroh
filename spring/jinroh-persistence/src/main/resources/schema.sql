...
(
  `ROOM_STATUS_EVENT_ID` BIGINT(19) IDENTITY,
  `ROOM_ID` BIGINT(19) NOT NULL,
  `ROOM_STATUS` CHAR(10) NOT NULL,
  `EVENT_TM` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `HOLIDAY_ROLE` (
  `HOLIDAY_ROLE_ID` BIGINT(19) IDENTITY,
  `GAME_ID` BIGINT(19) NOT NULL,
  `ROLE_ID` BIGINT(19) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `URNAISHI_NIGHT_ACT` (
    `URNAISHI_NIGHT_ACT_ID` BIGINT(19) IDENTITY,
    `FROM_GAME_PARTICIPATION_ID` BIGINT(19) NOT NULL UNIQUE,
    `TO_GAME_PARTICIPATION_ID` BIGINT(19) NULL,
...
CREATE TABLE IF NOT EXISTS `KAITO_NIGHT_ACT` (
    `KAITO_NIGHT_ACT_ID` BIGINT(19) IDENTITY,
    `FROM_GAME_PARTICIPATION_ID` BIGINT(19) NOT NULL UNIQUE,
    `TO_GAME_PARTICIPATION_ID` BIGINT(19) NULL,
...
CREATE TABLE IF NOT EXISTS `CO_EVENT` (
    `CO_EVENT_ID` BIGINT(19) IDENTITY,
    `GAME_ID` BIGINT(19) NOT NULL,
    `CO_TM` DATETIME NULL,
...
CREATE TABLE IF NOT EXISTS `CO_STATE` (
    `CO_EVENT_ID` BIGINT(19) NOT NULL,
    `GAME_PARTICIPATION_ID` BIGINT(19) NOT NULL,
    `ROLE_ID` BIGINT(19) NOT NULL,
